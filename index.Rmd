...
my_ggplotly <- function(plot, output_format = output_format, ...){
  if (interactive() || output_format == 'html'){ ## double | to only check second condition if first is false
    return(plotly::ggplotly(plot))
  } else {
    ggsave(plot = plot, filename = paste0("figures/", plot, ".png"))
    return(knitr::include_graphis(paste0("figures/", plot, ".png")))
  }
}

## Set figure width if pdf
if(output_format == 'pdf')
  knitr::opts_chunk$set(out.width = 4)
```
