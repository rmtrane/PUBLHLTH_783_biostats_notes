...
... let's clear the air. Based on previous experiences most of you think statistics is boring. 
...
.center[
  <img src="./images/planned_parenthood_abortion_chart_bs.jpg" height="200px">
]

.center[
  <img src="./images/planned_parenthood_abortion_chart_corrected.jpg" height="200px">
]
...
.center[
  ...
  Full paper [here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2685008/)  
]
...
3. From the sample, calculate quantities that help you say things about the "truth"
  - when interested in the incidence rate, simply calculate the incidence rate in the samples

--

The thing is, the samples won't mirror the populations *exactly* -- take a new sample, get new estimates of incidence rate.

The question then is: is the difference due to "differences in the truths", or is it simply "differences due to random samples"?
...
The main question: when is a difference "big enough"? How do we make that question less subjective?
...
This also means that if our assumptions are off, everything is off. 
--
 Therefore, important to state and check your assumptions!
...
* If unlikely, take that as evidence *against* 
