...
1. $X = \text{flip of a coin}$. Possible outcomes: heads and tails. 

--

2. $X = \text{sex of randomly chosen individual}$. Possible outcomes: male and female.

--

3. $X = \text{educational level of randomly chosen individual from the FHS}$. Possible outcomes: `r sort(unique(framingham$education), na.last = T)`.
