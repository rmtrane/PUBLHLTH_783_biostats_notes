...
So far in this part, we've talked about these super abstract concepts, such as probability [random variables](#random-variables) and [distributions](#a-few-important-distributions) that at first seem have nothing to do with the real world. So why did we spent so much time talking about these things? 
