...
if(file.exists('data/R_output/samples_RR.Rds')){
  ...
  write_rds(x = samples_RR, file = 'data/R_output/samples_RR.Rds')
}
...
if(!file.exists('data/R_output/RRs.Rds')){
  ...
  readr::write_rds(RRs, file = 'data/R_output/RRs.Rds')
} else {
  RRs <- readr::read_rds(file = 'data/R_output/RRs.Rds')
}
...
if(!file.exists('data/R_output/ORs.Rds')){
  ...
  readr::write_rds(ORs, file = 'data/R_output/ORs.Rds')
} else {
  ORs <- readr::read_rds(file = 'data/R_output/ORs.Rds')
}
...
```{theorem, label = "theCLT", name = "The Central Limit Theorem", echo = TRUE}
