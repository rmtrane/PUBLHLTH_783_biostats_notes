...
```{r height-averages-histogram, fig.cap = "Distribution of average heights.", cache = TRUE}
...
if(!file.exists('data/R_output/samples_RR.Rds')){
  ...
  readr::write_rds(samples_RR, path = 'data/R_output/samples_RR.Rds')
} else {
  samples_RR <- readr::read_rds(path = 'data/R_output/samples_RR.Rds')
}
