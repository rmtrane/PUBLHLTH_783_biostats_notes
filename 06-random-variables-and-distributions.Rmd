...
(**NOTE**: the rest of this subsection is not crucial for us, but is included for completeness. DO NOT panic if this seems super weird.)
...
if(!file.exists("data/R_output/binom_outcomes.Rds")){
  ...
  readr::write_rds(binom_outcomes, file = "data/R_output/binom_outcomes.Rds")
} else {
...
#### Linear Combination of Normal with Constants {#lin-comb-normals}
...
I want to reiterate the procedure of standardizing. Take a Normally distributed random variable, subtract its mean, and divide by the standard deviation will result in a new random variable that follows the standard normal distribution: $\frac{X - E(X)}{\SD(X)} \sim N(0,1)$. 
